...
// ==========================================
// 1. TELEGRAM BOT LOGIC (NO FORCE JOIN)
// ==========================================

// ዋና ሜኑ እና የጨዋታ አዝራር መላኪያ
...
// /start ወይም /play ሲባል ያለምንም ቻናል ቅድመ-ሁኔታ ቀጥታ ሜኑውን ይልካል
...
bot.on("callback_query", (query) => {
    ...
    if (data.startsWith("reject_")) {
        ...
        bot.sendMessage(targetUserId, `❌ የገቢ ጥያቄዎ አልፀደቀም።`);
        return bot.answerCallbackQuery(query.id);
    }
